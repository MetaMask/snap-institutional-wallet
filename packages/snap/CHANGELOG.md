...
- Remove old hacky cronjob implementation, implement "deep sleep" mechanism until the snap is used for the first time ([#54](https://github.com/MetaMask/snap-institutional-wallet/pull/54))
...
[Unreleased]: https://github.com/MetaMask/snap-institutional-wallet/compare/v1.2.0...HEAD
